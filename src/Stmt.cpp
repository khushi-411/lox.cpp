...
template <class T>
lox::stmt::Block<T>::Block(std::vector<lox::stmt::Stmt> statements)
...
template <class T>
lox::stmt::Expression<T>::Expression(lox::expr::Expr expression)
...
template <class T>
lox::stmt::Print<T>::Print(lox::expr::Expr expression)
    : expression(expression) {}
...
template <class T>
lox::stmt::Return<T>::Return(Token keyword, lox::expr::Expr value)
